...
const onload = async () => {
  ...
  const attachTranslationPopupEl = (el) => {
    ...
    function show(el) {
      ...
      const translations = story.keywords[word] || dictionary[word];
      tooltipEl.querySelector("#content").innerHTML = translations ? tplKeywordTranslations(translations) : "No Translation Found";
